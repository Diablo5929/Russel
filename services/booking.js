...
exports.add = [
  ...
  body("bookingId")
    .isNumeric()
    .withMessage("L'id de réservation doit être un nombre."),
  body("clientName")
    .trim()
    .isLength({ min: 3 })
    .withMessage("Le nom du client doit contenir au moins 3 caractères"),
  body("boatName")
    .trim()
    .isLength({ min: 3 })
    .withMessage("Le nom du bâteau doit contenir au moins 3 caractères"),
...
exports.update = [
  ...
  body("checkOut")
    .optional()
    .isDate()
    .withMessage("checkIn doit être une date"),
